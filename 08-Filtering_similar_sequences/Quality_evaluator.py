...
for family_name in tqdm.tqdm(list_families):
    if family_name == "Example":
        continue
    elif os.path.isfile(os.path.join(data_path, order, family_name, "04-Similar_sequences_removed", "".join([family_name, ".fasta"]))):
        ...
        qualityeval.evaluate(os.path.join(data_path, order, family_name, "04-Similar_sequences_removed", "".join([family_name, ".fasta"])), method)
