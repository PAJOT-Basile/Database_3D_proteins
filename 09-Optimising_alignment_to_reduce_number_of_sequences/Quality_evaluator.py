...
for family_name in tqdm.tqdm(list_families):
    if family_name == "Example":
        continue
    elif os.path.isfile(os.path.join(data_path, order, family_name, "05-Optimised_alignment", "".join([family_name, ".fasta"]))):
        ...
        qualityeval.evaluate(os.path.join(data_path, order, family_name, "05-Optimised_alignment", "".join([family_name, ".fasta"])), method)
